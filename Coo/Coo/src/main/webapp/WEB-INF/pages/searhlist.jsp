...
<div class="wrap">
    <div class="header">
        <div class="container">
            ...
            <ul class="nav">
                ...
                <li>
                    <a  href="${pageContext.request.contextPath}/recruit?k=企业招聘&p=1">企业招聘</a>
                </li>
                <li>
                    <a  href="${pageContext.request.contextPath}/recruit?k=校园招聘&p=1">校园招聘</a>
                </li>
                <li>
            ...
            <div class="links">
               <!--  <a href="/hr/index" rel="nofollow">企业入口</a>
                <span></span> -->
                <a rel="nofollow" class="student-login">欢迎您：lailai</a>
            </div>
                ...
                <ul class="filter-list filter-condition">
                    ...
                    <li class="clearfix" data-type="s">
                        ...
                        <ul class="list-item clearfix">
                            ...
                            <li data-val="s0,100" >100以下
                            </li>
                            <li data-val="s100,150" >100-150
                            </li>
                            <li data-val="s150,200" >150-200
                            </li>
                            <li data-val="s200,300" >200-300
                            </li>
                            <li data-val="s300,0" >300以上
                            </li>
                        </ul>
                    </li>
								...
								<c:forEach varStatus="a" var="post" items="${page.rows }">
	                                <li class="font">
	                                    <div class="info1">
	                                        ...
	                                        <a class="name" href="Recruit/job?post_id=${post.post_id }" target="_blank" data-info="1">${post.post_name}</a>
	...
	EFBSTTKN23UYJOH6K1CHBXPQOMLX0COM" target="_blank">
 						...
 						<div class="col-md-12 text-right">
							<itheima:page url="${pageContext.request.contextPath }/jobs/searchlist" />
		                </div>
