                    ...
                    <div class="new-content">
                        <ul class="question-content question_content2">
                            ...
                            <div class="page-li" my_attr="0" >
                                ...
                                <!--  ${empty user}-->
                                <c:if test="${empty notes.img }">
                                	<img alt="picture" src="${pageContext.request.contextPath}/images/nologin.jpg"/>
                                </c:if>
                                 <c:if test="${!empty notes.img }">
                                	<img alt="picture" src="${pageContext.request.contextPath}/upload/${notes.img}"/>
                                </c:if>
                                    <div class="question-msg">
                                        <p ></p>
                                        <p>${notes.note_title }</p>
                                    </div>
                                    <input type="hidden" value="${notes.note_id }">
                                    <p class="q-title one_row"> <a  onclick="x_admin_show('求职者论坛详情','${pageContext.request.contextPath}/note/notedetail?note_id=${notes.note_id }')">${notes.note_content }</a></p>
                                    <p class="q-desc two_row">${notes.note_time }

                                    </p>
                                    <div class="icons" my_id="RBBXHFMA9FC5WSLD7YJEJZ29XMRJTDIS">
                                        <span class="name time">2019-04-26 09:43:38</span>
