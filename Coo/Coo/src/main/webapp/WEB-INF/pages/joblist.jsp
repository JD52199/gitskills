...
<div class="wrap">
								...
								<c:forEach varStatus="a" var="post" items="${page.rows }">
	                                <li class="font">
	                                    <div class="info1">
	                                        ...
	                                        <a class="name" href="Recruit/job?post_id=${post.post_id }&username=${username}" target="_blank" data-info="1">${post.post_name}</a>
	...
	EFBSTTKN23UYJOH6K1CHBXPQOMLX0COM" target="_blank">
	                                         ...
	                                         <%--   <img alt="picture" src="${pageContext.request.contextPath}/upload/${post.img}"/> --%>
	                                        </a>
	                                    </div>
	                                </li>
								</c:forEach>
